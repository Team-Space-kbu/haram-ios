...
extension HaramError {
  var code: String? { // 하람 서버에서 제공하는 code, Notion 참고
    switch self {
    case .decodedError, .unknownedError, .requestError, .serverError, .noEqualPassword, .titleIsEmpty, .contentsIsEmpty, .uploadingImage, .networkError, .retryError, .timeoutError, .unvalidRefreshToken, .multipleLoginUser:
      return nil
