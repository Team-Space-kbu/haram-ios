...
final class WebViewController: BaseViewController {
  ...
  lazy var rtcPeerConnection = factory.peerConnection(with: rtcConfig, constraints: RTCMediaConstraints(mandatoryConstraints: nil, optionalConstraints: nil), delegate: nil)
