//
//  LectureInfoCollectionViewCell.swift
//  Haram
//
...
final class LectureInfoCollectionViewCell: UICollectionViewCell, ReusableView {
  ...
  private func configureUI() {
    ...
    [titleLabel, subLabel, typeStackView, indicatorButton].forEach { entireView.addSubview($0) }
