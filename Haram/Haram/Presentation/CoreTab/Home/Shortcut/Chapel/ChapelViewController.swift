...
final class ChapelViewController: BaseViewController {
  ...
  override func bind() {
    ...
    Observable.combineLatest(
      output.chapelHeaderModelRelay,
      output.chapelListModelRelay,
      output.chapelDetailModelRelay
    )
...
//    output.chapelHeaderModelRelay
//      .subscribe(with: self) { owner, chapelHeaderModel in
...
//    
//    output.chapelListModelRelay
//      .subscribe(with: self) { owner, chapelListModel in
